      ...
      <main>
        <div className={styles.main}>
          <h1 className={styles.title}>
            Masukin <span className={styles.span}>nama</span> kamuu sayaangg
          </h1>
        </div>
        {/* Theme Color  */}
        ...
        <div>
          <form className={styles.form} onSubmit={handleInput}>
            <input
              ...
              placeholder="Masukin nama disiniii"
              value={value}
              onChange={(e) => setValue(e.target.value)}
            />
            <Button className={styles.button} type="submit" text="Klikkkk siniii" />
          </form>
        </div>
      </main>
    </div>
